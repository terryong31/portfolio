...
const Shuffle: React.FC<ShuffleProps> = ({
    ...
    // const splitRef = useRef<GSAPSplitText | null>(null); // SplitText is a Club GSAP plugin, might not be available in free version or needs specific import. 
    // Assuming user provides valid code or has access. However, common issue: SplitText is NOT in 'gsap/SplitText' publicly.
    // Wait, the user provided import { SplitText as GSAPSplitText } from 'gsap/SplitText';
    ...
    useGSAP(
        () => {
            ...
            const build = () => {
                ...
                // Note: usage of GSAPSplitText assumes it's valid.
                try {
