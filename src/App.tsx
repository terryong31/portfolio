...
// Lazy load heavy components for better performance
// Beams is critical for LCP/visuals, so we load it eagerly now
    ...
    <Preloader>
      ...
      >
        <div className="relative w-full min-h-screen bg-black text-white">
          ...
          <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="px-4 md:px-28 absolute inset-0 z-10 flex flex-col md:flex-row items-center justify-center md:justify-between pointer-events-none gap-6 md:gap-0 h-svh overflow-hidden">
              <motion.div
                ...
                className="relative pointer-events-auto flex flex-col items-center md:items-start gap-6 text-center md:text-left pt-12 md:pt-0 w-full max-w-full"
              >
                {/* Mobile: Stacked Text */}
          ...
          {/* Threads Section */}
          <div style={{ width: '100%', position: 'relative', willChange: 'transform', transform: 'translateZ(0)' }} className="flex flex-col items-center justify-start px-4 md:px-20 overflow-hidden min-h-screen pt-16 pb-16 md:py-0 md:scroll-mb-0 md:my-0">
